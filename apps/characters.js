// apps/characters.js
// imports:
//   from '../core/storage.js': getData, generateId, getNow, getAllDB, getDB, setDB, deleteDB, getByIndexDB, compressImage
...
function createCharacterCard(character) {
  ...
  info.append(
    ...
    el('div', 'character-meta', `${getMoodLabel(character.mood)} · ${character.memoryTriggerCount || 100} 条触发记忆`)
  );
...
// 依赖：../core/storage.js 的 getData/generateId/getNow/getAllDB/getDB/setDB/deleteDB/getByIndexDB/compressImage；../core/ui.js 的 showToast/showBottomSheet/hideBottomSheet/showConfirm/createIcon
