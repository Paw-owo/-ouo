// apps/chat/list.js
// imports:
//   from '../../core/storage.js': getData, setData, generateId, getNow, setDB, getAllDB, getByIndexDB
...
// 改了什么：右上角新增建立群聊按钮，会用当前所有角色创建群聊并打开。
// 会不会影响其他文件：需要 core/storage.js 的 setDB 支持 setDB('groups', group)；如果不支持要改回三参数。
// 更新记忆里该文件的导出函数：无变化。
// 依赖：../../core/storage.js(getData,setData,generateId,getNow,setDB,getAllDB,getByIndexDB)；../../core/ui.js(createIcon,showToast)
