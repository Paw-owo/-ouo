...
// 改了什么：只新增 stopThreadAIReply 导出，并在 AI 回复时同步 state.aiGenerating，其他消息逻辑不动。
// 会不会影响其他文件：会，下一步需要改 apps/chat/thread.js 让发送按钮切换成停止按钮。
// 更新记忆里该文件的导出函数：sendThreadMessage / sendCardMessage / editThreadMessage / deleteThreadMessage / quoteThreadMessage / copyThreadMessage / regenerateThreadMessage / continueThreadMessage / stopThreadAIReply / sendTransferMessage / sendImageMessage / sendStickerMessage / sendDiceMessage / sendRpsMessage / playThreadTTS / stopThreadTTS。
