...
function buildIdentityPrompt(character, userName, userProfile = {}) {
  ...
  return [
    ...
    `- 我的 Thinking、记忆总结、正文回复都必须使用我的第一人称视角。`,
    `- 我的 Thinking 必须是简体中文，像我自己心里一闪而过的想法，不写成分析报告。`,
    `- 我不会在 Thinking 或正文里称呼对方为“用户”。`,
...
function buildModePrompt(mode, group, character, options, userName, userProfile = {}) {
  ...
  const base = [
    ...
    '- 如果我要表达思考，我会用 <thinking>...</thinking> 包住一小段简体中文内心想法。',
    `- Thinking 里我只写第一人称，不写“用户”，会写“${callName}”、关系称呼、他/她，或者直接写我自己的感受。`,
    '- Thinking 不是解释给别人看的命令稿，而是我自己心里短短想了一下。',
...
// 改了什么：只把聊天 AI 提示词改成第一人称表达，并加强 Thinking 简体中文、第一人称、禁用“用户”称呼。
