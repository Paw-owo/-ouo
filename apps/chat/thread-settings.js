...
function createVoiceSection() {
  ...
  section.append(
    ...
    labelBlock('语音服务', inputRow('', voice.provider || '', '例如 openai', (value) => updateVoiceConfig({ useGlobal: false, provider: value }))),
    labelBlock('语音模型', inputRow('', state.config.ttsModel || voice.model || '', '例如 tts-1', async (value) => {
