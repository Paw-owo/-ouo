...
//   from './thread-actions.js': sendThreadMessage, sendImageMessage, sendStickerMessage, sendTransferMessage, sendDiceMessage, sendRpsMessage
...
async function loadOptionalModules() {
  ...
  if (!sendThreadMessageFn || !sendImageMessageFn || !sendStickerMessageFn || !sendTransferMessageFn || !sendDiceMessageFn || !sendRpsMessageFn) {
...
function injectStyle() {
  ...
  style.textContent = `
    ...
    @media (prefers-reduced-motion: reduce) {
      ...
      .chat-thread-tool-grid,
      .chat-thread-tool-card,
      .chat-sticker-icon-grid { animation: none; }
    }
  `;
