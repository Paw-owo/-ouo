...
// 改了什么：接入 stopThreadAIReply，AI 回复中发送按钮切换为停止按钮，并给等待消息加 pending 标记和输入状态动画。
// 会不会影响其他文件：会，需确保 apps/chat/thread-actions.js 已导出 stopThreadAIReply，apps/chat/thread-ai.js 已支持 stopThreadAIReply/isPending/isStopped。
// 更新记忆里该文件的导出函数：无变化。
