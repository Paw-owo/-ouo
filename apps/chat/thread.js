...
const THREAD_CSS_HREF = './thread-style.css';
const PAGE_SIZE = 50;
...
// 改了什么：修正 thread-style.css 加载路径，从错误的 ./chat/thread-style.css 改成 ./thread-style.css。
// 会不会影响其他文件：不会。
// 更新记忆里该文件的导出函数：mountChatThread(containerEl, options)、unmountChatThread()、getThreadContext()
