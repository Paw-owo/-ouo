...
//   from './thread-panels.js': openThreadToolsPanel, openThreadSettingsPanel, closeThreadPanels
...
function createHeader() {
 ...
 back.addEventListener('click', () => {
  ...
  title.addEventListener('click', () => openThreadSettingsPanel(state));
 ...
 const settings = iconButton('settings', '设置');
  settings.addEventListener('click', () => openThreadSettingsPanel(state));
...
function startProactiveChecks() {
  ...
  window.setTimeout(() => runProactiveCheck(), 800);
