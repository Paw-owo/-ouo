...
function injectStyle() {
  ...
  style.textContent = `
    ...
    .chat-config-switch-ui{width:46px;height:28px;border-radius:999px;background:var(--surface-muted);box-shadow:var(--shadow-sm);transition:background 200ms ease}
...
// 改了什么：修了输入法回车误发、切换后不能发、工具栏滑动乱跳、发送失败界面卡住，顺手把搜索和错误提示补清楚。
// 会不会影响其他文件：不会，只改 apps/chat/thread.js。
