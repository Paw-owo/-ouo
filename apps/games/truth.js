  ...
  const messages = [
    {
      ...
      content: [
        ...
        persona ? `你的人设：\n${persona}` : '',
        '你正在玩多人真心话大冒险。',
        '输赢、玩法、惩罚类型都由前端随机决定，你不能否认结果，不能改结果。',
        '必须使用第一人称“我”说话，就像 ChatAI 私聊里的自然回复。',
        '不要说“他/她/TA会”，不要写旁白，不要写动作解说，不要提系统规则。',
        '如果是真心话，就用第一人称诚实回答。',
        '如果是大冒险，就用第一人称接受、拒绝或给出符合人设的反应。',
        '回复要短，像现场直接说出来的话。'
      ].filter(Boolean).join('\n')
    },
    {
  ...
  const messages = [
    {
      ...
      content: [
        ...
        persona ? `你的人设：\n${persona}` : '',
        '你正在玩多人真心话大冒险。',
        '用户输了，你要给用户出一道真心话或指定一个大冒险。',
        '必须用第一人称语气，像你本人正在对用户说话。',
        '只输出题目或任务本身，不要解释，不要旁白，不要提系统规则。'
      ].filter(Boolean).join('\n')
    },
    {
      role: 'user',
...
// 依赖：../../core/storage.js 的 getData/setData/getAllDB/getDB/setDB/deleteDB/generateId/getNow/compressImage；../../core/ui.js 的 createIcon/showToast/showBottomSheet/hideBottomSheet/showConfirm；../../core/api.js 的 silentRequest
