...
const ICON_PATHS = {
  ...
  phone: [
    ["path", { d: "M8.2 5.4l2 3.2-1.5 1.6c.9 1.8 2.3 3.2 4.1 4.1l1.6-1.5 3.2 2c.4.3.6.8.4 1.3-.5 1.5-1.7 2.7-3.2 2.9-5.1-.8-9-4.7-9.8-9.8.2-1.5 1.4-2.7 2.9-3.2.5-.2 1 .1 1.3.4z" }]
  ],
  mic: [
  ...
  star: [
    ["path", { d: "M12 4.5l2.2 4.5 5 .7-3.6 3.5.9 5-4.5-2.4-4.5 2.4.9-5-3.6-3.5 5-.7L12 4.5z" }]
  ],
  heart: [
    ["path", { d: "M12 19s-7-4.4-7-9.4A3.7 3.7 0 018.8 6c1.3 0 2.5.7 3.2 1.8A3.8 3.8 0 0115.2 6 3.7 3.7 0 0119 9.6C19 14.6 12 19 12 19z" }]
  ],
  camera: [
...
function clearActiveDialog(result) {
...
function createDialog(message, resolve, cancelValue) {
  if (activeDialog) {
  ...
  const overlay = createElement("div", ["sheet-overlay", "open"]);
  const container = createElement("div", "guide-overlay");
  const card = createElement("div", "guide-card");
  const title = createElement("h2", "guide-title", "提示");
  const text = createElement("p", "guide-text", message ?? "");
  ...
  actions.classList.add("form-control");
  ...
  overlay.addEventListener("click", () => clearActiveDialog(cancelValue));
...
export function showConfirm(message) {
  return new Promise((resolve) => {
    ...
    const cancelButton = createElement("button", "btn-ghost", "取消");
    const confirmButton = createElement("button", "btn-primary", "确认");
...
export function showAlert(message) {
  return new Promise((resolve) => {
    ...
    const confirmButton = createElement("button", "btn-primary", "知道了");
    confirmButton.type = "button";
...
/* 依赖：无import；挂载 window.showToast；使用 style.css 的 .toast / .bottom-sheet / .sheet-overlay / .btn-primary / .btn-ghost / .guide-overlay / .guide-card / .form-row / .form-control */
